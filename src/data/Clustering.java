...
public class Clustering {
  public static void main(String[] args) throws Exception {
	// -t /some/where/data.arff -W "weka.clusterers.EM -I 50"
    // load data
    Instances train = DataSource.read("newData.arff");
...
//    options[0] = "";
    Clusterer clusterer = AbstractClusterer.forName("weka.clusterers.EM", null);
